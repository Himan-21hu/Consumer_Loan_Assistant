...
public class Consumer_Loan_Assistant extends JFrame implements ActionListener {
    ...
    // ALL THE LOGIC IMPLEMENTATION i.e values insertion and condition for
    // validation
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) {
            try {
                ...
                // if we want to calculate monthly payment by giving the value of no. of
                // payments.
                ...
                // if we want to calculate no. of payment by giving the value of monthly
                // payments.
